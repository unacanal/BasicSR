...
"""HAN implementation from https://github.com/wwlCape/HAN/blob/master/src/model/han.py"""
...
class HAN(nn.Module):
    def __init__(self,
        ...
        # define head module
        modules_head = [conv(n_in_ch, n_feats, kernel_size)]
        ...
        modules_tail = [
            ...
            conv(n_feats, n_in_ch, kernel_size)]
